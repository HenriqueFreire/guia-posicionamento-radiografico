...
export const INCIDENCIAS: IncidenciaRadiografica[] = [
  ...
  },
  {
    ...
    raioCentral: 'Perpendicular, incidindo 2,5 cm abaixo do processo coracoide. No método de Grashey, é o paciente que roda 35°–45° em direção ao lado examinado — o RC permanece perpendicular ao receptor.',
  ...
  },
  {
    ...
    gradeRecomendada: true,
    raioCentral: 'Angulado de 10° a 15° caudal, incidindo pelo aspecto posteromedial do ombro, perpendicular ao plano da escápula, passando tangencialmente sob a borda inferior do acrômio em direção à cabeça umeral.',
  ...
  },
  {
    ...
    tamanhoChassi: '24×30 cm transversal',
    gradeRecomendada: false,
    raioCentral: 'Angulado de 25° a 30° cefálico, incidindo no ponto médio da clavícula.',
    ...
    dicaPratica: 'Biotipos brevilíneos geralmente ficam bem com 25°–30°. Biotipos longilíneos podem precisar de apenas 15°–20° cefálico — ajuste sempre para projetar a clavícula acima dos arcos costais.',
  ...
  },
  {
    ...
    gradeRecomendada: true,
    raioCentral: 'Perpendicular, incidindo 3,8 cm (1,5 polegada) acima da borda superior da sínfise púbica, no plano sagital médio.',
